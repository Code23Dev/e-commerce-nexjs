                        ...
                        <div className="compare-table">
                            <div className="compare-row cols-xl-5 cols-lg-4 cols-md-3 cols-2 compare-products">
                                ...
                                <div className="compare-col compare-product">
                                    <a href="#" className="btn remove-product"><i
                                        className="w-icon-times-solid"></i></a>
                                    <div className="product text-center">
                                        <figure className="product-media">
                                            <a href="product-default.html">
                                                <img src="assets/images/products/elements/1.jpg" alt="Product"
                                                     width="228"
                                                     height="257"/>
                                            </a>
                                ...
                                <div className="compare-col compare-product">
                                    ...
                                    <div className="product text-center">
                                        <figure className="product-media">
                                            <a href="product-default.html">
                                                <img src="assets/images/products/elements/2.jpg" alt="Product"
                                                     width="228"
                                                     height="257"/>
                                            </a>
                                            <div className="product-action-vertical">
                                        ...
                                        <div className="product-details">
                                            <h3 className="product-name"><a href="product-default.html">Summer Sport
                                                Shoes</a>
                                            </h3>
                                        </div>
                                    </div>
                                ...
                                <div className="compare-col compare-product">
                                    ...
                                    <div className="product text-center">
                                        <figure className="product-media">
                                            <a href="product-default.html">
                                                <img src="assets/images/products/elements/3.jpg" alt="Product"
                                                     width="228"
                                                     height="257"/>
                                            </a>
                                            <div className="product-action-vertical">
                                ...
                                <div className="compare-col compare-product">
                                    ...
                                    <div className="product text-center">
                                        <figure className="product-media">
                                            <a href="product-default.html">
                                                <img src="assets/images/products/elements/4-1.jpg" alt="Product"
                                                     width="228"
                                                     height="257"/>
                                            </a>
                                            <div className="product-action-vertical">
                            ...
                            <div className="compare-row cols-xl-5 cols-lg-4 cols-md-3 cols-2 compare-reviews">
                                ...
                                <div className="compare-col compare-rating">
                                    <div className="ratings-container">
                                        ...
                                        <a href="#" className="rating-reviews">(8 Reviews)</a>
                                    </div>
                                </div>
                                <div className="compare-col compare-rating">
                                    <div className="ratings-container">
                            ...
                            <div className="compare-row cols-xl-5 cols-lg-4 cols-md-3 cols-2 compare-color">
                                ...
                                <div className="compare-col compare-value">
                                    ...
                                    <span className="swatch" style={{backgroundColor: '#00ff00'}} title="Red"></span>
