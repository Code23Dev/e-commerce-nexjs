                ...
                <main className="main">
                    <div className="page-content">
                        <div className="container">
                            ...
                            <div className="title-link-wrapper mb-4 appear-animate">
                                <h2 className="title">Top Categories</h2>
                                <a href="shop-boxed-banner.html" className="text-capitalize font-weight-bold">More
                                    Products<i
                                        className="w-icon-long-arrow-right"></i></a>
                            </div>
                            <div className="row mb-7 category-products-wrapper appear-animate">
                                <div className="col-xl-3 col-lg-4 col-md-5">
                                    <ul className="category-wrapper list-style-none">
                                        <li><a href="shop-banner-sidebar.html"><i
                                            className="w-icon-tshirt"></i>Clothing &amp;
                                            Apparel</a></li>
                                        <li><a href="shop-banner-sidebar.html"><i className="w-icon-camera"></i>Digital
                                            Cameras</a>
                                        </li>
                                        <li><a href="shop-banner-sidebar.html"><i className="w-icon-mobile"></i>Smartphones</a>
                                        </li>
                                        <li><a href="shop-banner-sidebar.html"><i className="w-icon-sofa"></i>Home &amp;
                                            Furnitures</a></li>
                                        <li><a href="shop-banner-sidebar.html"><i
                                            className="w-icon-computer"></i>Computers &amp;
                                            Laptops</a></li>
                                        <li><a href="shop-banner-sidebar.html"><i className="w-icon-basketball"></i>Sport</a>
                                        </li>
                                        <li><a href="shop-banner-sidebar.html"><i
                                            className="w-icon-bow"></i>Toys &amp; Baby</a>
                                        </li>
                                        <li><a href="shop-banner-sidebar.html"><i
                                            className="w-icon-ruby"></i>Accessories &amp;
                                            Jewelry</a></li>
                                    </ul>
                                </div>
                                ...
                                'breakpoints': {
                                    ...
                                    '1400': {
                                        ...
                                        <div className="swiper-wrapper row cols-xl-5 cols-lg-4 cols-md-3 cols-2">
                                            <div className="swiper-slide product-col">
                                                <div className="product product-slideup-content">
                                                    <figure className="product-media">
                                                        <a href="product-default.html">
                                                            <img src="assets/images/demos/demo7/products/4-1.jpg"
                                                                 alt="Product"
                                                    ...
                                                    <div className="product-hidden-details">
                                                        <div className="product-action">
                                                            <a href="#" className="btn-product btn-cart"
                                                               title="Add to Cart">
                                                                <i className="w-icon-cart"></i><span>Add To Cart</span></a>
                                                            <a href="#"
                                                ...
                                                <div className="product product-slideup-content">
                                                    <figure className="product-media">
                                                        <a href="product-default.html">
                                                            <img src="assets/images/demos/demo7/products/4-2.jpg"
                                                                 alt="Product"
                                                                 width="187" height="210"/>
                                                        </a>
                                                        <div className="product-action-vertical">
                                                    ...
                                                    <div className="product-details">
                                                        ...
                                                        <div className="product-price">
                                                            <ins className="new-price">$73.71</ins>
                                                            <del className="old-price">$78.04</del>
                                                        </div>
                                                    </div>
                                                    <div className="product-hidden-details">
                                                        <div className="product-action">
                                            ...
                                            <div className="swiper-slide product-col">
                                                <div className="product product-slideup-content">
                                                    <figure className="product-media">
                                                        <a href="product-default.html">
                                                            <img src="assets/images/demos/demo7/products/4-3.jpg"
                                                                 alt="Product"
                                                                 width="187" height="210"/>
                                                        </a>
                                                        <div className="product-action-vertical">
                                                ...
                                                <div className="product product-slideup-content">
                                                    <figure className="product-media">
                                                        <a href="product-default.html">
                                                            <img src="assets/images/demos/demo7/products/4-4.jpg"
                                                                 alt="Product"
                                                                 width="187" height="210"/>
                                                        </a>
                                                        <div className="product-action-vertical">
                                            ...
                                            <div className="swiper-slide product-col">
                                                <div className="product product-slideup-content">
                                                    <figure className="product-media">
                                                        <a href="product-default.html">
                                                            <img src="assets/images/demos/demo7/products/4-5.jpg"
                                                                 alt="Product"
                                                                 width="187" height="210"/>
                                                        </a>
                                                        <div className="product-action-vertical">
                                                    ...
                                                    <div className="product-details">
                                                        ...
                                                        <div className="product-price">
                                                            <ins className="new-price">$49.99</ins>
                                                        </div>
                                                    </div>
                                                    <div className="product-hidden-details">
                                                        <div className="product-action">
                                                ...
                                                <div className="product product-slideup-content">
                                                    <figure className="product-media">
                                                        <a href="product-default.html">
                                                            <img src="assets/images/demos/demo7/products/4-6.jpg"
                                                                 alt="Product"
                                                                 width="187" height="210"/>
                                                        </a>
                                                        <div className="product-action-vertical">
                                            ...
                                            <div className="swiper-slide product-col">
                                                <div className="product product-slideup-content">
                                                    <figure className="product-media">
                                                        <a href="product-default.html">
                                                            <img src="assets/images/demos/demo7/products/4-7.jpg"
                                                                 alt="Product"
                                                                 width="187" height="210"/>
                                                        </a>
                                                        <div className="product-action-vertical">
                                                    ...
                                                    <div className="product-details">
                                                        ...
                                                        <div className="product-price">
                                                            <ins className="new-price">$65.89 - $69.99</ins>
                                                        </div>
                                                    </div>
                                                    <div className="product-hidden-details">
                                                        <div className="product-action">
                                                ...
                                                <div className="product product-slideup-content">
                                                    <figure className="product-media">
                                                        <a href="product-default.html">
                                                            <img src="assets/images/demos/demo7/products/4-8.jpg"
                                                                 alt="Product"
                                                                 width="187" height="210"/>
                                                        </a>
                                                        <div className="product-action-vertical">
                                                    ...
                                                    <div className="product-details">
                                                        ...
                                                        <div className="product-price">
                                                            <ins className="new-price">$69.99</ins>
                                                            <del className="old-price">$84.16</del>
                                                        </div>
                                                    </div>
                                                    <div className="product-hidden-details">
                                                        <div className="product-action">
                                            ...
                                            <div className="swiper-slide product-col">
                                                <div className="product product-slideup-content">
                                                    <figure className="product-media">
                                                        <a href="product-default.html">
                                                            <img src="assets/images/demos/demo7/products/4-9.jpg"
                                                                 alt="Product"
                                                                 width="187" height="210"/>
                                                        </a>
                                                        <div className="product-action-vertical">
                                                ...
                                                <div className="product product-slideup-content">
                                                    <figure className="product-media">
                                                        <a href="product-default.html">
                                                            <img src="assets/images/demos/demo7/products/4-10.jpg"
                                                                 alt="Product"
                                                                 width="187" height="210"/>
                                                        </a>
                                                        <div className="product-action-vertical">
                                                    ...
                                                    <div className="product-details">
                                                        ...
                                                        <div className="product-price">
                                                            <ins className="new-price">$232.62</ins>
                                                        </div>
                                                    </div>
                                                    <div className="product-hidden-details">
                                                        <div className="product-action">
                            ...
                            <div className="title-links-wrapper title-underline mb-4 d-flex align-items-center appear-animate">
                                <h2 className="title">Consumer Electronics</h2>
                                <ul
                                    className="nav-links list-style-none d-flex align-items-center flex-wrap justify-content-center">
                            ...
                            <div className="row banner-product-wrapper appear-animate">
                                <div className="col-xl-3 col-lg-4 col-md-5 mb-4 mb-md-0">
                                    <div className="banner banner-fixed br-xs" style={{backgroundImage: 'url(assets/images/demos/demo7/banner/1.jpg)', backgroundColor: '#363634'}}>
                                        <div className="banner-content">
                                            <h5 className="banner-subtitle text-white text-uppercase ls-25 font-weight-bold">New
                                                Arrivals</h5>
                                            <h3 className="banner-title text-white text-capitalize ls-25">Premium True
                                                Wireless
                                                Earbuds</h3>
                                            <div className="banner-price-info text-white font-weight-bold ls25">Sale up
                                                to <span
                                                    className="text-primary text-uppercase">20% Off</span></div>
                                ...
                                'breakpoints': {
                                    ...
                                    '1200': {
                                        ...
                                        <div className="swiper-wrapper row cols-xl-4 cols-lg-3 cols-md-2 cols-2">
                                            <div className="swiper-slide product-col">
                                                <div className="product product-slideup-content">
                                                    <figure className="product-media">
                                                        <a href="product-default.html">
                                                            <img src="assets/images/demos/demo7/products/5-1.jpg"
                                                                 alt="Product"
                                                ...
                                                <div className="product product-slideup-content">
                                                    <figure className="product-media">
                                                        <a href="product-default.html">
                                                            <img src="assets/images/demos/demo7/products/5-2.jpg"
                                                                 alt="Product"
                                                                 width="239" height="269"/>
                                                        </a>
                                                        <div className="product-action-vertical">
                                                    ...
                                                    <div className="product-details">
                                                        <h3 className="product-name">
                                                            <a href="product-default.html">Mobile Electronic
                                                                Recorder</a>
                                                        </h3>
                                                        <div className="ratings-container">
                                                            <div className="ratings-full">
                                            ...
                                            <div className="swiper-slide product-col">
                                                <div className="product product-slideup-content">
                                                    <figure className="product-media">
                                                        <a href="product-default.html">
                                                            <img src="assets/images/demos/demo7/products/5-3.jpg"
                                                                 alt="Product"
                                                                 width="239" height="269"/>
                                                        </a>
                                                        <div className="product-action-vertical">
                                                    ...
                                                    <div className="product-details">
                                                        ...
                                                        <div className="product-price">
                                                            <ins className="new-price">$78.99</ins>
                                                        </div>
                                                    </div>
                                                    <div className="product-hidden-details">
                                                        <div className="product-action">
                                                ...
                                                <div className="product product-slideup-content">
                                                    <figure className="product-media">
                                                        <a href="product-default.html">
                                                            <img src="assets/images/demos/demo7/products/5-4.jpg"
                                                                 alt="Product"
                                                                 width="239" height="269"/>
                                                        </a>
                                                        <div className="product-action-vertical">
                                                    ...
                                                    <div className="product-details">
                                                        ...
                                                        <div className="product-price">
                                                            <ins className="new-price">$73.71</ins>
                                                            <del className="old-price">$250.68</del>
                                                        </div>
                                                    </div>
                                                    <div className="product-hidden-details">
                                                        <div className="product-action">
                                            ...
                                            <div className="swiper-slide product-col">
                                                <div className="product product-slideup-content">
                                                    <figure className="product-media">
                                                        <a href="product-default.html">
                                                            <img src="assets/images/demos/demo7/products/5-5.jpg"
                                                                 alt="Product"
                                                                 width="239" height="269"/>
                                                        </a>
                                                        <div className="product-action-vertical">
                                                    ...
                                                    <div className="product-details">
                                                        ...
                                                        <div className="product-price">
                                                            <ins className="new-price">$18.06</ins>
                                                        </div>
                                                    </div>
                                                    <div className="product-hidden-details">
                                                        <div className="product-action">
                                                ...
                                                <div className="product product-slideup-content">
                                                    <figure className="product-media">
                                                        <a href="product-default.html">
                                                            <img src="assets/images/demos/demo7/products/5-6.jpg"
                                                                 alt="Product"
                                                                 width="239" height="269"/>
                                                        </a>
                                                        <div className="product-action-vertical">
                                            ...
                                            <div className="swiper-slide product-col">
                                                <div className="product product-slideup-content">
                                                    <figure className="product-media">
                                                        <a href="product-default.html">
                                                            <img src="assets/images/demos/demo7/products/5-7.jpg"
                                                                 alt="Product"
                                                                 width="239" height="269"/>
                                                        </a>
                                                        <div className="product-action-vertical">
                                                    ...
                                                    <div className="product-details">
                                                        ...
                                                        <div className="product-price">
                                                            <ins className="new-price">$19.03</ins>
                                                            <del className="old-price">$22.11</del>
                                                        </div>
                                                    </div>
                                                    <div className="product-hidden-details">
                                                        <div className="product-action">
                                                ...
                                                <div className="product product-slideup-content">
                                                    <figure className="product-media">
                                                        <a href="product-default.html">
                                                            <img src="assets/images/demos/demo7/products/5-8.jpg"
                                                                 alt="Product"
                                                                 width="239" height="269"/>
                                                        </a>
                                                        <div className="product-action-vertical">
                                                    ...
                                                    <div className="product-details">
                                                        ...
                                                        <div className="product-price">
                                                            <ins className="new-price">$63.20</ins>
                                                        </div>
                                                    </div>
                                                    <div className="product-hidden-details">
                                                        <div className="product-action">
                            ...
                            <div className="row pb-1 banner-product-wrapper appear-animate">
                                <div className="col-xl-3 col-lg-4 col-md-5 mb-4 mb-md-0">
                                    <div className="banner banner-fixed br-xs" style={{backgroundImage: 'url(assets/images/demos/demo7/banner/2.jpg)', backgroundColor: '#CCCFD4'}}>
                                        <div className="banner-content">
                                            <h5 className="banner-subtitle text-white text-uppercase font-weight-bold ls-25">Weekend
                                                Sale</h5>
                                            <h3 className="banner-title text-white text-capitalize ls-25">New Fashion
                                                Collection
                                            </h3>
                                            <div className="banner-price-info text-white font-weight-bold ls25">From
                                                only <span
                                                    className="text-primary text-uppercase">$185.00</span></div>
                                            <a href="shop-banner-sidebar.html"
                                               className="btn btn-white btn-outline btn-rounded">Shop Now</a>
                                        </div>
                                    </div>
                                        ...
                                        <div className="swiper-wrapper row cols-xl-4 cols-lg-3 cols-md-2 cols-2">
                                            <div className="swiper-slide product-col">
                                                <div className="product product-slideup-content">
                                                    <figure className="product-media">
                                                        <a href="product-default.html">
                                                            <img src="assets/images/demos/demo7/products/6-1.jpg"
                                                                 alt="Product"
                                                                 width="239" height="269"/>
                                                        </a>
                                                        <div className="product-action-vertical">
                                                ...
                                                <div className="product product-slideup-content">
                                                    <figure className="product-media">
                                                        <a href="product-default.html">
                                                            <img src="assets/images/demos/demo7/products/6-2.jpg"
                                                                 alt="Product"
                                                                 width="239" height="269"/>
                                                        </a>
                                                        <div className="product-action-vertical">
                                                    ...
                                                    <div className="product-details">
                                                        ...
                                                        <div className="product-price">
                                                            <ins className="new-price">$23.58 - $45.62</ins>
                                                        </div>
                                                    </div>
                                                    <div className="product-hidden-details">
                                                        <div className="product-action">
                                            ...
                                            <div className="swiper-slide product-col">
                                                <div className="product product-slideup-content">
                                                    <figure className="product-media">
                                                        <a href="product-default.html">
                                                            <img src="assets/images/demos/demo7/products/6-3.jpg"
                                                                 alt="Product"
                                                                 width="239" height="269"/>
                                                        </a>
                                                        <div className="product-action-vertical">
                                                    ...
                                                    <div className="product-details">
                                                        ...
                                                        <div className="product-price">
                                                            <ins className="new-price">$78.23</ins>
                                                        </div>
                                                    </div>
                                                    <div className="product-hidden-details">
                                                        <div className="product-action">
                                                ...
                                                <div className="product product-slideup-content">
                                                    <figure className="product-media">
                                                        <a href="product-default.html">
                                                            <img src="assets/images/demos/demo7/products/6-4.jpg"
                                                                 alt="Product"
                                                                 width="239" height="269"/>
                                                        </a>
                                                        <div className="product-action-vertical">
                                            ...
                                            <div className="swiper-slide product-col">
                                                <div className="product product-slideup-content">
                                                    <figure className="product-media">
                                                        <a href="product-default.html">
                                                            <img src="assets/images/demos/demo7/products/6-5.jpg"
                                                                 alt="Product"
                                                                 width="239" height="269"/>
                                                        </a>
                                                        <div className="product-action-vertical">
                                                    ...
                                                    <div className="product-details">
                                                        ...
                                                        <div className="product-price">
                                                            <ins className="new-price">$75.00</ins>
                                                ...
                                                <div className="product product-slideup-content">
                                                    <figure className="product-media">
                                                        <a href="product-default.html">
                                                            <img src="assets/images/demos/demo7/products/6-6.jpg"
                                                                 alt="Product"
                                                                 width="239" height="269"/>
                                                        </a>
                                                        <div className="product-action-vertical">
                                                    ...
                                                    <div className="product-details">
                                                        ...
                                                        <div className="ratings-container">
                                                            ...
                                                            <a href="#" className="rating-reviews">(6 Reviews)</a>
                                                        </div>
                                                        <div className="product-price">
                                                            <ins className="new-price">$220.20</ins>
                                                            <del className="old-price">$232.62</del>
                                                        </div>
                                                    </div>
                                                    <div className="product-hidden-details">
                                                        <div className="product-action">
                                            ...
                                            <div className="swiper-slide product-col">
                                                <div className="product product-slideup-content">
                                                    <figure className="product-media">
                                                        <a href="product-default.html">
                                                            <img src="assets/images/demos/demo7/products/6-7.jpg"
                                                                 alt="Product"
                                                                 width="239" height="269"/>
                                                        </a>
                                                        <div className="product-action-vertical">
                                                    ...
                                                    <div className="product-details">
                                                        ...
                                                        <div className="product-price">
                                                            <ins className="new-price">$32.36</ins>
                                                            <del className="old-price">$37.00</del>
                                                        </div>
                                                    </div>
                                                    <div className="product-hidden-details">
                                                        <div className="product-action">
                                                ...
                                                <div className="product product-slideup-content">
                                                    <figure className="product-media">
                                                        <a href="product-default.html">
                                                            <img src="assets/images/demos/demo7/products/6-8.jpg"
                                                                 alt="Product"
                                                                 width="239" height="269"/>
                                                        </a>
                                                        <div className="product-action-vertical">
                        ...
                        <div className="product-details scrollable pl-0">
                            ...
                            <hr className="product-divider"/>
                                ...
                                <div className="accordion accordion-simple mb-9">
                                            ...
                                            <div className="row">
                                                <div className="col-md-6">
                                                    ...
                                                    <ul className="list-type-check list-style-none pl-0">
                                                        ...
                                                        <li>Ultrices eros in cursus turpis massa tincidunt ante in nibh
                                                            mauris.
                                                        </li>
                                                    </ul>
                                                </div>
                                            ...
                                            <div className="row cols-md-3">
                                                <div className="mb-3">
                                                    <h5 className="sub-title font-weight-bold"><span
                                                        ...
                                                        Shipping &amp; Return</h5>
                                                    <p className="detail pl-5">We offer free shipping for products on
                                                        orders
                                                        above 50$ and offer free delivery for all orders in US.</p>
                                                </div>
                                                <div className="mb-3">
                                                    <h5 className="sub-title font-weight-bold"><span>2.</span>Free and
                                                        Easy
                                                        Returns</h5>
                                                    <p className="detail pl-5">We guarantee our products and you could
                                                        get back
                                    ...
                                    <div className="card">
                                        <div className="card-header ls-normal">
                                            <a href="#product-tab-reviews" className="expand">Customer Reviews(3)</a>
                                        </div>
                                        <div className="card-body collapsed" id="product-tab-reviews">
                                                ...
                                                <div className="col-xl-8 col-lg-7 mb-4">
                                                    <div className="review-form-wrapper">
                                                        <h3 className="title tab-pane-title font-weight-bold mb-1">Submit
                                                            Your
                                                            Review</h3>
                                                        <p className="mb-3">Your email address will not be published.
                                                            Required
                                                            fields are marked *</p>
                                                        ...
                                                        <a className="star-5" href="#">5</a>
                                                            ...
                                                            <div className="form-group">
                                                                <input type="checkbox" className="custom-checkbox"
                                                                       id="save-checkbox"/>
                                                                    <label htmlFor="save-checkbox">Save my name, email,
                                                                        and website
                                            ...
                                            <div className="tab tab-nav-boxed tab-nav-outline tab-nav-center">
                                                <ul className="nav nav-tabs" role="tablist">
                                                    ...
                                                    <li className="nav-item">
                                                        <a href="#helpful-positive" className="nav-link">Most Helpful
                                                            Positive</a>
                                                    </li>
                                                    <li className="nav-item">
                                                        <a href="#helpful-negative" className="nav-link">Most Helpful
                                                            Negative</a>
                                                    </li>
                                                    <li className="nav-item">
                                                    ...
                                                    <li className="nav-item">
                                                        <a href="#lowest-rating" className="nav-link">Lowest Rating</a>
                                                    </li>
                                                </ul>
                                    ...
                                    <div className="card">
                                        ...
                                        <div className="card-body collapsed" id="product-tab-vendor">
                                            <div className="row mb-3">
                                                ...
                                                <div className="col-md-6 pl-2 pl-md-6 mb-4">
                                                    <div className="vendor-user">
                                                        ...
                                                        <div>
                                                            <div className="vendor-name"><a href="#">Jone Doe</a></div>
                                                            <div className="ratings-container">
                                                                <div className="ratings-full">
                                                                    <span className="ratings"
                                                                          style={{width: '90%'}}></span>
                                                                ...
                                                                <a href="#" className="rating-reviews">(32 Reviews)</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <p className="mb-5"><strong className="text-dark">L</strong>orem ipsum dolor
                                                sit amet,
                                            ...
                                            <p className="mb-2"><strong className="text-dark">A</strong> arcu cursus
                                                ...
                                                Diam in
                                                arcu cursus euismod quis. Eget sit amet tellus cras adipiscing enim eu.
                                                In
                                                fermentum et sollicitudin ac orci phasellus. A condimentum vitae sapien
                                                pellentesque
                                                habitant morbi tristique senectus et. In dictum non consectetur a erat.
                                                Nunc
                                    ...
                                    <div className="social-links-wrapper">
                                        <div className="social-links">
                                            <div className="social-icons social-no-color border-thin">
                                                ...
                                                <a href="#" className="social-icon social-tiktok"><i
                                                    style={{color: '#5a5a5a'}} className="fab fa-tiktok"></i></a>
                                            </div>
                                        </div>
