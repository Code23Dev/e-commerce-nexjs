...
//
      ...
      if(JSON.parse(localStorage.getItem('data2'))){
          ...
          allProducts()
              .then(items => {
                  ...
                  JSON.parse(localStorage.getItem('data2')) ? setData2(JSON.parse(localStorage.getItem('data2'))) : []
              })
      }
    }, [])
    //
    ...
    const showQuickviewm = (e) =>{
        setQuickviewList([e])
        quickviewList.map(r=>{setQuickviewListImages(r.images)})
        quickviewList.map(r=>{setQuickviewListFilterValues(r.filter_values)})
    }
                            ...
                            <div className="category-wrap mb-4">
                                <div className="category category-group-image br-sm">
                                    <div className="category-content">
                                        <h4 className="category-name"><a href={`shop/${e.id}?card`}>{e.category.title}</a>
                                        </h4>
                                        <ul className="category-list">
                                            {e.category.sub_categories.map(item=>(
                                                <li><a href={`shop/${e.id}?card`}>{item.title}</a></li>
                                            ))}
                                    ...
                                    <figure className="product-media">
                                        ...
                                        <div className="product-action-horizontal">
                                            ...
                                            <a href="#" className="btn-product-icon  w-icon-compare"
                                               onClick={()=>{addCompare(e)}}
                                               title="Compare"></a>
                                            <a href="#" onClick={()=>showQuickviewm(e)} className="btn-product-icon btn-quickview w-icon-search"
                                               title="CƏLD BAXIŞ"></a>
                                        </div>
                                    </figure>
                                    <div className="product-details">
                                        ...
                                        <a href={`shop/${e.id}`} className="rating-reviews">({e.rating}
                                            reviews)</a>
                                        </div>
                ...
                <div className="row gutter-lg">
                            ...
                            'prevEl': '.swiper-button-prev'
                                ...
                                <div className="product-thumbs swiper-wrapper row cols-4 gutter-sm">
                                    <div className="product-thumb swiper-slide">
                                        {quickviewList.map(e=>(
                                            <img src={e.main_image} alt="Product Thumb"
                                                 width="103"
                                                 height="116"/>
                                        ))}
                                    </div>
                                    {quickviewListImages.map(e=>{
                                        <div className="product-thumb swiper-slide">
                                            <img src={e.image} alt="Product Thumb"
                                                 width="103"
                                                 height="116"/>
                                        </div>
                                    })}
                    ...
                    <div className="col-md-6 overflow-hidden p-relative">
                        <div className="product-details scrollable pl-0">
                            {quickviewList.map(e=>(<h2 className="product-title">{e.title}</h2>))}
                            ...
                            {quickviewList.map(e=>(<div className="product-price">₼ {e.price}</div>))}
                            ...
                            <div className="product-short-desc">
                                <ul className="list-type-check list-style-none">
                                    {quickviewList.map(e=>(<li>{e.short_desc1}</li>))}
                                    {quickviewList.map(e=>(<li>{e.short_desc2}</li>))}
                                    {quickviewList.map(e=>(<li>{e.short_desc3}</li>))}
                                </ul>
                            </div>
