                                                    ...
                                                    <li>
                                                        ...
                                                        <hr className="divider"/>
                                                            <ul>
                                                                ...
                                                                <li><a href="shop-fullwidth-banner.html">Trending</a>
                                                                </li>
                                                                <li><a href="shop-fullwidth-banner.html">Clothing</a>
                                                                </li>
                                                        ...
                                                        <hr className="divider"/>
                                                            <ul>
                                                                <li><a href="shop-fullwidth-banner.html">Beds, Frames &
                                                                    Bases</a></li>
                                                                <li><a href="shop-fullwidth-banner.html">Dressers</a>
                                                                </li>
                                                                <li><a href="shop-fullwidth-banner.html">Nightstands</a>
                                                                </li>
                                                                <li><a href="shop-fullwidth-banner.html">Kid's Beds &
                                                                    Headboards</a></li>
                                                                <li><a href="shop-fullwidth-banner.html">Armoires</a>
                                                                </li>
                                                            </ul>
                                                            ...
                                                            <hr className="divider"/>
                                                                <ul>
                                                                    ...
                                                                    <li><a href="shop-fullwidth-banner.html">Chairs</a>
                                                                    </li>
                                                                    <li><a href="shop-fullwidth-banner.html">Tables</a>
                                                                    </li>
                                                    ...
                                                    <li>
                                                        ...
                                                        <hr className="divider"/>
                                                            <ul>
                                                                ...
                                                                <li><a href="shop-fullwidth-banner.html">Bookcases</a>
                                                                </li>
                                                        ...
                                                        <hr className="divider"/>
                                                            <ul>
                                                                <li><a href="shop-fullwidth-banner.html">Desktop
                                                                    Computers</a></li>
                                                                <li><a href="shop-fullwidth-banner.html">Monitors</a>
                                                                </li>
                                                    ...
                                                    <li className="row">
                                                        <div className="col-md-3 col-lg-3 col-6">
                                                            ...
                                                            <ul>
                                                                ...
                                                                <li><a href="shop-fullwidth-banner.html">Armchairs</a>
                                                                </li>
                                            ...
                                            <ul className="megamenu">
                                                <li>
                                                    ...
                                                    <ul>
                                                        ...
                                                        <li><a href="shop-fullwidth-banner.html">Full Width Banner</a>
                                                        </li>
                                                ...
                                                <li>
                                                    ...
                                                    <ul>
                                                        ...
                                                        <li><a href="product-without-sidebar.html">Without Sidebar</a>
                                                        </li>
                                                        <li><a
                                                            href="product-video.html">360<sup>o</sup> &amp; Video<span
                                                            className="tip tip-new">New</span></a></li>
                                                    </ul>
                                                </li>
                                                <li>
                                        ...
                                        <li>
                                            ...
                                            <ul>
                                                <li>
                                                    ...
                                                    <ul>
                                                        <li><a href="vendor-dokan-store-list.html">Store listing 1</a>
                                                        </li>
                                                        <li><a href="vendor-wcfm-store-list.html">Store listing 2</a>
                                                        </li>
                                                        <li><a href="vendor-wcmp-store-list.html">Store listing 3</a>
                                                        </li>
