                                    ...
                                    <div className="order-summary-wrapper sticky-sidebar">
                                        ...
                                        <div className="order-summary">
                                            <table className="order-table">
                                                ...
                                                <tr className="bb-no">
                                                    <td className="product-name">Brown Backpack <i
                                            ...
                                            <div className="payment-methods" id="payment_method">
                                                <h4 className="title font-weight-bold ls-25 pb-0 mb-1">Payment
                                                    Methods</h4>
                                                <div className="accordion payment-accordion">
                                                    <div className="card">
                                                        <div className="card-header">
                                                            <a href="#cash-on-delivery" className="collapse">Direct Bank
                                                                Transfor</a>
                                                        </div>
                                            ...
                                            <div className="form-group place-order pt-6">
                                                <button type="submit"
                                                        className="btn btn-dark btn-block btn-rounded">Place Order
                                                </button>
                                            </div>
                                        </div>
                                    </div>
