                    ...
                    <div className="tab tab-nav-boxed tab-nav-center tab-nav-underline">
                        ...
                        <div className="tab-content">
                            <div className="tab-pane active" id="sign-in">
                                ...
                                <div className="form-checkbox d-flex align-items-center justify-content-between">
                                    <input type="checkbox" className="custom-checkbox" id="remember2" name="remember"
                                           required=""/>
                                        <label htmlFor="remember">İstifadəçippppppppppppppp</label>
                                </div>
                                <div className="form-checkbox d-flex align-items-center justify-content-between">
                                    <input type="checkbox" className="custom-checkbox" id="remember3" name="remember"
                                           required=""/>
                                        <label htmlFor="remember">Satıcı</label>
                                </div>
                                <div className="form-checkbox d-flex align-items-center justify-content-between">
                                    <input type="checkbox" className="custom-checkbox" id="remember4" name="remember"
                                           required=""/>
                            ...
                            <div className="tab-pane" id="sign-up">
                                ...
                                <div className="form-group mb-5">
                                    <label>Password *</label>
                                    <input type="text" className="form-control" name="password_1" id="password_1"
                                           required/>
                                </div>
                                <p>Your personal data will be used to support your experience
                                    throughout this website, to manage access to your account,
                                    and for other purposes described in our <a href="#" className="text-primary">privacy
                                        policy</a>.</p>
                                ...
                                <div className="form-checkbox d-flex align-items-center justify-content-between mb-5">
                                    <input type="checkbox" className="custom-checkbox" id="agree" name="agree"
                                           required=""/>
                                        <label htmlFor="agree" className="font-size-md">I agree to the <a href="#"
                                                                                                          className="text-primary font-size-md">privacy
                                            policy</a></label>
                                </div>
                                <div className="form-checkbox d-flex align-items-center justify-content-between">
                                    <input type="checkbox" className="custom-checkbox" id="remember2" name="remember"
                                           required=""/>
                                        <label htmlFor="remember">İstifadəçi</label>
                                </div>
                                <div className="form-checkbox d-flex align-items-center justify-content-between">
                                    <input type="checkbox" className="custom-checkbox" id="remember3" name="remember"
                                           required=""/>
