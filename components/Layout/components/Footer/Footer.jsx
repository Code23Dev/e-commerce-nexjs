                        ...
                        <div className="row justify-content-center align-items-center">
                            ...
                            <div className="col-xl-7 col-lg-6 col-md-9 mt-4 mt-lg-0 ">
                                <form action="#" method="get"
                                    ...
                                    <button className="btn btn-primary btn-rounded" type="submit">Subscribe
                        ...
                        <div className="row">
                            <div className="col-lg-4 col-sm-6">
                                <div className="widget widget-about mt-0 mb-4">
                                    <a href="demo14.html" className="logo-footer">
                                        <img src="assets/images/demos/demo14/footer-logo.png" alt="logo-footer" width="145" height="45"/>
                                    </a>
