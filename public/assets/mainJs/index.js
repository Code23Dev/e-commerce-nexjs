!(function (e, t) {
    ...
    function ce(e, t) {
        for (var n, r, i = [], o = 0, a = e.length; o < a; o++)
            (r = e[o]).style &&
            ((n = r.style.display),
                t ? ("none" === n && ((i[o] = Y.get(r, "display") || null), i[o] || (r.style.display = "")), "" === r.style.display && ae(r) && (i[o] = le(r))) : "none" !== n && ((i[o] = "none"), Y.set(r, "display", n)));
    ...
    function be(e, t, n, r, i) {
        ...
        for (f.textContent = "", d = 0; (o = p[d++]); )
            ...
            else if (((l = ie(o)), (a = ye(f.appendChild(o), "script")), l && me(a), n)) for (c = 0; (o = a[c++]); ) ge.test(o.type || "") && n.push(o);
        return f;
    }
    var we = /^key/,
        ...
        add: function (e, t, n, r, i) {
            ...
            if (V(e))
                for (
                    ...
                    (p = u[d]) || (((p = u[d] = []).delegateCount = 0), (f.setup && !1 !== f.setup.call(e, r, h, a)) || (e.addEventListener && ("scroll" == d ? e.addEventListener(d, a, { passive: !0 }) : e.addEventListener(d, a)))),
    ...
    function Me(e, t, n, r) {
        ...
        if (p && ((a = (i = be(t, e[0].ownerDocument, !1, e, r)).firstChild), 1 === i.childNodes.length && (i = a), a || r)) {
            for (u = (s = w.map(ye(i, "script"), He)).length; f < p; f++) (l = i), f !== g && ((l = w.clone(l, !0, !0)), u && w.merge(s, ye(l, "script"))), n.call(e[f], l, f);
            if (u)
                for (c = s[s.length - 1].ownerDocument, w.map(s, Oe), f = 0; f < u; f++)
                    ...
                    w.contains(c, l) &&
                    (l.src && "module" !== (l.type || "").toLowerCase() ? w._evalUrl && !l.noModule && w._evalUrl(l.src, { nonce: l.nonce || l.getAttribute("nonce") }, c) : m(l.textContent.replace(qe, ""), l, c));
        }
        return e;
    }
    function Ie(e, t, n) {
    ...
    w.extend({
        ...
        clone: function (e, t, n) {
            var r,
                ...
                s = e.cloneNode(!0),
                u = ie(e);
            if (!(d.noCloneChecked || (1 !== e.nodeType && 11 !== e.nodeType) || w.isXMLDoc(e))) for (a = ye(s), r = 0, i = (o = ye(e)).length; r < i; r++) Re(o[r], a[r]);
            if (t)
    ...
    function _e(e, t, n) {
        ...
        return (
            ...
            !d.pixelBoxStyles() && We.test(a) && $e.test(t) && ((r = s.width), (i = s.minWidth), (o = s.maxWidth), (s.minWidth = s.maxWidth = s.width = a), (a = n.width), (s.width = r), (s.minWidth = i), (s.maxWidth = o))),
                void 0 !== a ? a + "" : a
        );
    }
    function ze(e, t) {
        ...
        prefilters: [
            function (e, t, n) {
                ...
                if ((u = !w.isEmptyObject(t)) || !w.isEmptyObject(d))
                    ...
                    "none" === (c = w.css(e, "display")) && (l ? (c = l) : (ce([e], !0), (l = e.style.display || l), (c = w.css(e, "display")), ce([e]))),
        ...
        w.extend({
            ...
            ajax: function (t, n) {
                ...
                for (f in ((c = w.event && d.global) && 0 == w.active++ && w.event.trigger("ajaxStart"),
                    ...
                    (i = d.url.replace(qt, "")),
                    d.hasContent
                        ? d.data && d.processData && 0 === (d.contentType || "").indexOf("application/x-www-form-urlencoded") && (d.data = d.data.replace(jt, "+"))
                        : ((p = d.url.slice(i.length)),
                        d.data && (d.processData || "string" == typeof d.data) && ((i += (Et.test(i) ? "&" : "?") + d.data), delete d.data),
                        !1 === d.cache && ((i = i.replace(Lt, "$1")), (p = (Et.test(i) ? "&" : "?") + "_=" + Ct.guid++ + p)),
                            (d.url = i + p)),
                d.ifModified && (w.lastModified[i] && E.setRequestHeader("If-Modified-Since", w.lastModified[i]), w.etag[i] && E.setRequestHeader("If-None-Match", w.etag[i])),
                ...
                function S(t, n, a, u) {
                    ...
                    !f && w.inArray("script", d.dataTypes) > -1 && (d.converters["text script"] = function () {}),
                        (b = (function (e, t, n, r) {
                            var i,
                                o,
                                a,
                        ...
                        f
                            ? (d.ifModified && ((T = E.getResponseHeader("Last-Modified")) && (w.lastModified[i] = T), (T = E.getResponseHeader("etag")) && (w.etag[i] = T)),
        ...
        (w.parseHTML = function (e, t, n) {
            return "string" != typeof e
                ...
                t || (d.createHTMLDocument ? (((r = (t = v.implementation.createHTMLDocument("")).createElement("base")).href = v.location.href), t.head.appendChild(r)) : (t = v)),
                    (o = !n && []),
                    (i = N.exec(e)) ? [t.createElement(i[1])] : ((i = be([e], t, o)), o && o.length && w(o).remove(), w.merge([], i.childNodes)));
            var r, i, o;
        }),
